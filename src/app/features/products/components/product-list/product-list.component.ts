...
export class ProductListComponent implements OnInit {
  ...
  products: Array<Products> = [
    ...
    { nome: 'Caderno universitário', preco: 12, img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQo1tu8uS1NSr27KhH3v9f3jk1vAi1SKRnAgw&usqp=CAU"},
    ...
    { nome: 'Caderno espiral ', preco: 10, img: "https://images.unsplash.com/photo-1612599316791-451087c7fe15?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bm90ZWJvb2tzfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"},
    { nome: 'Agenda ', preco: 45, img: "https://images.unsplash.com/photo-1617177435596-1c9e30d6d608?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fG5vdGVib29rc3xlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"},
